"""
Django settings for nft_ecommerce_store project.
...
SECRET_KEY = 'django-insecure-a%u7x-2*^*n+i0(q1$xe@kb4-!8lq(-%236s%hq%6%p==wfmvr'
...
ROOT_URLCONF = 'nft_ecommerce_store.urls'
